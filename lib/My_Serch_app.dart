    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.bookmark_add_outlined,color: Colors.black),label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.arrow_back_ios_new,color: Colors.black),label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.refresh,color: Colors.black),label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.arrow_forward_ios_outlined,color: Colors.black),label: ''),
